...
// === HTTP SERVER ===
// Hinter Nginx liefert Nginx das Frontend statisch aus (/opt/battleship-deluxe/public).
// Dieser Node-Prozess beantwortet nur Healthchecks und WebSocket-Upgrades unter /ws.
...
// roomCode -> { players:[ws1,ws2], spectators:[ws...], names:[], boards:{}, readyById:{}, turn }
const rooms = new Map();

// --- WebSocket Keepalive (stabile Verbindungen hinter Proxies)
...
// 🧩 Hilfsfunktionen für Boardlogik
function createBoard(cells) {
  ...
  // benachbarte Felder verbinden (horizontal/vertikal)
